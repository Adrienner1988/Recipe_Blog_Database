...
class Recipe(models.Model):
    ...
    category = models.ForeignKey(Category, related_name='category', on_delete=models.CASCADE, null=False, blank=False, default=0) 
    ...
    serving = models.ForeignKey(Serving, related_name='recipe_servings', on_delete=models.CASCADE, null=False, blank=False, default=0)
